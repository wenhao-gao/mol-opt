...
def read_dataset_encoding(disc_enc_type):
    ...
    smiles_reference = data.smiles_lst.tolist()[:10000]
    return smiles_reference
    # elif disc_enc_type == 'selfies':
    #     selfies_reference = read_dataset(filename=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'datasets/SELFIES_zinc.txt'))
