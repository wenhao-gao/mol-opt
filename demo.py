...
optimizer = MIMOSA(smi_file=None, n_jobs=-1, max_oracle_calls=1000, freq_log=100, output_dir = 'results', log_results=True) 
optimizer.optimize(oracle='qed', patience=5, seed=0)


print('reinvent') ### wrong 
